...
graph TD
    ...
    ParallelAgent --> GeminiAgent[🤖 Gemini 2.5 Flash Model]
...
4. **Gemini 2.5 Flash Synthesis**: Deconstructs research into a grounded concept, recommended scene beats, and an explicit uncertainty rating.
