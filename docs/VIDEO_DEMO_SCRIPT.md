...
- **[1:30 - 2:15] Local Gemini-shaped Synthesis Fixture**: Show the local synthesis fixture distilling the fixture evidence into a grounded title, scene beats, and a clear market viability critique with an explicit uncertainty rating.
